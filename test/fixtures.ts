...
import type { Breach, Paste, SubscriptionStatus } from '../src/api/haveibeenpwned/types.js';
...
export const UNVERIFIED_BREACH: Breach = {
  ...
  DataClasses: ['Dates of birth', 'Email addresses', 'Genders', 'Names', 'Passwords', 'Usernames'],
  IsVerified: false,
  IsFabricated: false,
  IsSensitive: true,
  IsRetired: false,
